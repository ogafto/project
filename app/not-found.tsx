    ...
    <div className="min-h-screen bg-[#0E0E11] text-white flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md w-full text-center space-y-6 bg-white/[0.03] border border-white/10 p-8 rounded-3xl backdrop-blur-xl shadow-2xl">
        ...
        <div className="pt-4 flex flex-col gap-3">
          <Link
            href="/"
            className="w-full py-3.5 px-6 rounded-xl bg-gradient-to-r from-[#FF5B28] to-[#FF8C38] text-white font-semibold text-sm hover:opacity-90 transition shadow-lg shadow-[#FF5B28]/20 flex items-center justify-center gap-2"
          >
            Strona główna platformy
          </Link>
          <Link
            href="/logowanie"
            className="w-full py-3 px-6 rounded-xl bg-white/5 border border-white/10 text-zinc-300 font-medium text-sm hover:bg-white/10 hover:text-white transition flex items-center justify-center"
          >
