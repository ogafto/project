...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#0A0B0D] text-white flex flex-col items-center justify-center px-4 relative overflow-hidden font-['Poppins',sans-serif]">
      ...
      <div className="relative z-10 max-w-md w-full text-center space-y-6 bg-[#111319]/90 border border-[#1C1E26] p-8 rounded-3xl backdrop-blur-xl shadow-2xl">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-white font-['Sora',sans-serif]">
