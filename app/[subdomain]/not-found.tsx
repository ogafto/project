...
export default function SubdomainNotFound() {
  return (
    <div className="min-h-screen bg-[#0E0E11] text-white flex flex-col items-center justify-center p-6 text-center font-sans">
      ...
      <h1 className="text-2xl font-bold font-sans">Sklep nie został odnaleziony</h1>
      <p className="text-xs text-zinc-400 mt-2 max-w-md font-sans leading-relaxed">
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-center gap-3 font-sans">
        <Link
          href="/dashboard"
